...
\usepackage{graphicx}
\graphicspath{{target/img/},{uzory/},{target/header/}}
...
\newcommand\myemph[1]{\mysmall{\myheadingcolor #1}}
\newcommand\myemphn[1]{{\myheadingcolor #1}}
...
\renewcommand{\LettrineFontHook}{\color{kinovar}\fontseries{bx}}
%\setcounter{DefaultLines}{4}
%\renewcommand{\DefaultLraise}{0.03}
%\setlength{\DefaultNindent}{0em}
\renewcommand{\DefaultLoversize}{0.03}
